...
function crear3PartidosMock() {
  const transaccion = db.transaction(() => {
    ...
    for (let p = 0; p < partidas.length; p++) {
      ...
      // Agregar 14 jugadores: 7 titulares, 7 suplentes
      for (let j = 0; j < 14; j++) {
    ...
    console.log(`✓ 42 jugadores creados con perfiles completos`);
    console.log(`✓ 3 partidos 7 vs 7 creados con todos los jugadores inscritos`);
  });
